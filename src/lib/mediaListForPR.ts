...
export const mediaListForGhit: MediaListItem[] = [
  ...
  },
  {
    ...
    index: 2,
    caption: 'モバイル表示用には別レイアウトを用意。また日本語・英語の2言語に対応しました。',
  },
  {
...
export const mediaListFor311: MediaListItem[] = [
  {
    ...
    index: 0,
    caption:
      'ビジュアルデザインに関しては広告代理店から素材の支給があったため、サイト制作の実作業はコーディング以降をすべて担当する形となりました。',
  },
];
...
export const mediaListForSatNav: MediaListItem[] = [
  {
    ...
    index: 0,
    caption: 'PC版。車のアニメーションは位置が固定されており、背景とメインコンテンツである道路標識のみがスクロールする構造。',
  },
  {
...
export const mediaListForYoshimotozaka: MediaListItem[] = [
  {
    ...
    index: 0,
    caption: 'トップの集合素材のバランス調整に、全工程の90%の時間を使ったと言っても過言ではない',
  },
];
