...
import { mediaListForApp, mediaListForManaging } from '../../lib/mediaListForChie';

const Chie = () => {
  const [isVisibleMediaViewerForManaging, setIsVisibleMediaViewerForManaging] = useState(false);
  const [selectedIndexForManaging, setSelectedIndexForManaging] = useState(0);
  const [isVisibleMediaViewerForApp, setIsVisibleMediaViewerForApp] = useState(false);
    ...
    <div className="Chie">
      <div className="Chie__contents">
        ...
        <section className="Chie__contentsManaging">
          ...
          <ul className="Chie__contentsManagingTags util-BadgeList">
            <li className="util-BadgeList__item">
              <Badge color="yellow" text="UI改善" />
            </li>
            <li className="util-BadgeList__item">
              <Badge color="yellow" text="UGCサイト運用" />
            </li>
            <li className="util-BadgeList__item">
              <Badge color="yellow" text="ログ分析" />
            </li>
          </ul>
          ...
          <p>
            ...
            <br />
            しかしながら実はトラフィックの多くは、知りたいことを検索した結果、Yahoo!知恵袋で類似の質問を見つけて参照する「閲覧ユーザー」が大半。Yahoo!知恵袋のコンテンツ拡充のために、
            <span className="util-Text--highlighted">いかに「質問ユーザー」と「回答ユーザー」を増やすか</span>
            が課題でした。
          </p>
          <p>
          ...
          <div className="Chie__contentsManagingImage">
            <button onClick={() => showMediaViewerForManaging(0)} className="Chie__contentsManagingImageThumbnail">
              <img src={thumbnailChie} alt="Yahoo!知恵袋の画像" width="100%" height="auto" />
            </button>
        ...
        <section className="Chie__contentsApp">
          ...
          <ul className="Chie__contentsAppTags util-BadgeList">
            <li className="util-BadgeList__item">
              <Badge color="yellow" text="UI設計" />
            </li>
            <li className="util-BadgeList__item">
              <Badge color="yellow" text="ビジュアル設計" />
            </li>
            <li className="util-BadgeList__item">
              <Badge color="yellow" text="アプリ向けデザイン" />
            </li>
          </ul>

          <p>
            Yahoo! JAPAN アプリ内部にYahoo!知恵袋の機能を保持したいという依頼がありました。
            <br />
            Yahoo!知恵袋は（当時）紫と黄色をキーカラーとしたサービスでしたが、Yahoo! JAPAN
            は青とピンクがベース。またYahoo!知恵袋の大量かつ複雑なコンテンツの機能すべてをもたせる必要はないということで、
            <span className="util-Text--highlighted">必要最低限の要素をピックアップし、それに合わせてUIとビジュアルを刷新</span>
            しました。
            <br />（
          ...
          <div className="Chie__contentsAppImage">
            <button onClick={() => showMediaViewerForApp(0)} className="Chie__contentsAppImageThumbnail">
              <img src={thumbnailApp} alt="Yahoo! JAPAN アプリ向けのYahoo!知恵袋の画像" width="100%" height="auto" />
            </button>
        ...
        <section className="Chie__contentsRenewal">
          <Heading level={2} text="Yahoo!知恵袋 リニューアル + モダン環境移行" />
          <ul className="Chie__contentsRenewalTags util-BadgeList">
            <li className="util-BadgeList__item">
              <Badge color="yellow" text="リニューアル" />
            </li>
            <li className="util-BadgeList__item">
              <Badge color="yellow" text="モダン化" />
            </li>
            <li className="util-BadgeList__item">
              <Badge color="yellow" text="イメージボード作成" />
            </li>
          </ul>
          ...
          <p>
            ...
            <span className="util-Text--highlighted">
              レポジトリを統合する方針に切り替わり、デザイナーもReact やVue などでコーディングするようになりました。
            </span>
            （Yahoo!知恵袋はReactを採用）
            <br />
            同時にデザインのリニューアルについても、方向性の検討やイメージボードの作成を進めました。（残念ながら途中で他サービスの全社プロジェクト参加のためYahoo!知恵袋から離脱）
          </p>
          <div className="Chie__contentsRenewalLink">
            <Button href="https://chiebukuro.yahoo.co.jp/" color="yellow" text="Yahoo!知恵袋" iconRight="arrow_upper_right" />
        ...
        <section className="Chie__contentsRolls">
          ...
          <ul className="Chie__contentsRollsList">
            ...
            <li className="Chie__contentsRollsListItem">
              <Icon type="hyphen" size="medium" color="primary" />
              <span>ビジュアルデザイン（イラストレーション / サービスデザイン）</span>
            </li>
            <li className="Chie__contentsRollsListItem">
              <Icon type="hyphen" size="medium" color="primary" />
              <span>コーディング（HTML / SASS / PHP / React + JavaScript）</span>
            </li>
          </ul>
        ...
        <div className="Chie__contentsBack">
          <Button href="./" color="yellow" text="トップページへ戻る" iconLeft="arrow_left" isInline={true} target="_self" />
        </div>
      </div>
      ...
      {isVisibleMediaViewerForApp && (
        <MediaViewer mediaList={mediaListForApp} selectedIndex={selectedIndexForApp} onClickHandlerForClosing={hideMediaViewerForApp} />
      )}
    </div>
  );
};
