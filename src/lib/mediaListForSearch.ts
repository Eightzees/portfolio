...
export const mediaListForDD: MediaListItem[] = [
  {
    ...
    index: 0,
    caption:
      '検索ワードに対してその場で一発回答するものや、特定の人物や物事を深堀りしたもの（現在のナレッジパネルの前身）など、通常のショートカットモジュールよりは場所を取るけれど有益だったり、Yahoo!検索の再訪問につながるものを企画しました。',
  },
  {
    imagePath: imageDD1,
    index: 1,
    caption:
      'スターウォーズの日を盛り上げるためにルーカスフィルム（当時）と協力して、検索結果画面をスターウォーズ仕様にする企画。冒頭のメッセージをスターウォーズのオープニングのような表現にしたくて、斜めのパースで自動スクロールするロジックを実装しました。',
  },
  {
    imagePath: imageDD2,
    index: 2,
...
export const mediaListForPR: MediaListItem[] = [
  {
    ...
    index: 0,
    caption:
      '質問・疑問に一発回答したいというYahoo!検索の方針にピッタリの書籍をプロモーションする企画。電車内の釣り広告なども展開しました。主にコーディングとフロントエンドを担当。',
  },
  {
    imagePath: imagePR1,
    index: 1,
    caption:
      '毎年年末が近くなるとYahoo!検索で公開していた「Yahoo!検索ランキング」の特集ページ。恒例企画だったので、毎年ランキングの集計で年末を感じていました。主にコーディングとフロントエンドを担当。現在の「Yahoo!検索大賞」の前身企画。',
  },
  {
    imagePath: imagePR2,
    index: 2,
    caption: 'Yahoo!検索主体で企画した、のちに毎年恒例となる東日本の復興支援企画のウェブサイト。初年度と2年目を担当しました。',
  },
  {
    imagePath: imagePR3,
    index: 3,
    caption:
      'ヴィジュアルデザインを外部に発注した珍しいパターンの企画。オフライン広告も展開しました。コーディングとフロントエンドを担当。制作時に他社と直接やり取りする珍しい機会となり、いつもと違うスケジュール管理・素材管理が必要でした。',
  },
  {
    imagePath: imagePR4,
    index: 4,
